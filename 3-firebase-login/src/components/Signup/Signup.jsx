...
export function Signup () {
    ...
    return (<div className={styles.container}>
        <div className={styles.innerBox}>
            ...
            <InputControl label="Name" placeholder="Ingrese un nombre" onChange={(event)=> setvalues((prev)=>({...prev,name:event.target.value}))}/>
            <InputControl label="Email" placeholder="Ingrese un correo" onChange={(event)=> setvalues((prev)=>({...prev,email:event.target.value}))}/>
