        ...
        return (
            ...
            <div className="container">
                ...
                <div className="search__panel">
                    ...
                    <input type="text" placeholder="Búsqueda por título, empresas" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
                    </div>
                    <div className="search__panel-02">
                    <input type="text" placeholder="Búsqueda por ubicación"
